...
> La guía detallada de reproducción paso a paso está en `estado.md`.

---

## 📄 Documentación

En `docs/` hay dos documentos que explican el proyecto en profundidad: el **guion de la defensa** (recorrido narrado de todo el trabajo) y el **documento de estudio** (el porqué de cada decisión analítica, con glosario de términos).
